# Run SmartUI XCUI Tests on TestMu AI (Formerly LambdaTest)

<p align="center">
  <a href="https://www.testmuai.com/"><img src="https://img.shields.io/badge/MADE%20BY%20TestMu%20AI-000000.svg?style=for-the-badge&labelColor=000" alt="Made by TestMu AI"></a>
  <a href="https://smartui.lambdatest.com/"><img src="https://img.shields.io/badge/SmartUI-XCUI%20Testing-blue.svg?style=for-the-badge&labelColor=000" alt="SmartUI XCUI Testing"></a>
...
With TestMu AI (Formerly LambdaTest), you can run SmartUI visual regression tests for XCUI (iOS UI testing framework) across real iOS devices. This sample shows how to configure SmartUI XCUI tests to run on the TestMu AI cloud.
...
1. Clone this repository:
    ```bash
    git clone https://github.com/LambdaTest/smartui-xcui
    cd smartui-xcui
    ```

2. Build your iOS app and test runner IPA files using Xcode or `xcodebuild`.
...
For XCUI tests, set the `tunnel` capability to `true` in your test configuration to route device traffic through the TestMu AI tunnel.
